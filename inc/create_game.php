...
<input type="hidden" name="siegbedingungen" value="<?=$HTTP_POST_VARS["siegbedingungen"]?>">
<input type="hidden" name="zielinfo_1" value="<?=$HTTP_POST_VARS["zielinfo_1"]?>">
<input type="hidden" name="zielinfo_2" value="<?=$HTTP_POST_VARS["zielinfo_2"]?>">
<input type="hidden" name="zielinfo_3" value="<?=$HTTP_POST_VARS["zielinfo_3"]?>">
<input type="hidden" name="zielinfo_4" value="<?=$HTTP_POST_VARS["zielinfo_4"]?>">
<input type="hidden" name="zielinfo_5" value="<?=$HTTP_POST_VARS["zielinfo_5"]?>">
<input type="hidden" name="user_1" value="<?=$HTTP_POST_VARS["user_1"]?>">
<input type="hidden" name="user_2" value="<?=$HTTP_POST_VARS["user_2"]?>">
<input type="hidden" name="user_3" value="<?=$HTTP_POST_VARS["user_3"]?>">
<input type="hidden" name="user_4" value="<?=$HTTP_POST_VARS["user_4"]?>">
<input type="hidden" name="user_5" value="<?=$HTTP_POST_VARS["user_5"]?>">
<input type="hidden" name="user_6" value="<?=$HTTP_POST_VARS["user_6"]?>">
<input type="hidden" name="user_7" value="<?=$HTTP_POST_VARS["user_7"]?>">
<input type="hidden" name="user_8" value="<?=$HTTP_POST_VARS["user_8"]?>">
<input type="hidden" name="user_9" value="<?=$HTTP_POST_VARS["user_9"]?>">
<input type="hidden" name="user_10" value="<?=$HTTP_POST_VARS["user_10"]?>">
<input type="hidden" name="rasse_1" value="<?=$HTTP_POST_VARS["rasse_1"]?>">
<input type="hidden" name="rasse_2" value="<?=$HTTP_POST_VARS["rasse_2"]?>">
<input type="hidden" name="rasse_3" value="<?=$HTTP_POST_VARS["rasse_3"]?>">
<input type="hidden" name="rasse_4" value="<?=$HTTP_POST_VARS["rasse_4"]?>">
<input type="hidden" name="rasse_5" value="<?=$HTTP_POST_VARS["rasse_5"]?>">
<input type="hidden" name="rasse_6" value="<?=$HTTP_POST_VARS["rasse_6"]?>">
<input type="hidden" name="rasse_7" value="<?=$HTTP_POST_VARS["rasse_7"]?>">
<input type="hidden" name="rasse_8" value="<?=$HTTP_POST_VARS["rasse_8"]?>">
<input type="hidden" name="rasse_9" value="<?=$HTTP_POST_VARS["rasse_9"]?>">
<input type="hidden" name="rasse_10" value="<?=$HTTP_POST_VARS["rasse_10"]?>">
<input type="hidden" name="spieler_admin" value="<?=$HTTP_POST_VARS["spieler_admin"]?>">
<input type="hidden" name="startposition" value="<?=$HTTP_POST_VARS["startposition"]?>">
<input type="hidden" name="imperiumgroesse" value="<?=$HTTP_POST_VARS["imperiumgroesse"]?>">
<input type="hidden" name="geldmittel" value="<?=$HTTP_POST_VARS["geldmittel"]?>">
<input type="hidden" name="mineralienhome" value="<?=$HTTP_POST_VARS["mineralienhome"]?>">
<input type="hidden" name="sternendichte" value="<?=$HTTP_POST_VARS["sternendichte"]?>">
<input type="hidden" name="mineralien" value="<?=$HTTP_POST_VARS["mineralien"]?>">
<input type="hidden" name="spezien" value="<?=$HTTP_POST_VARS["spezien"]?>">
<input type="hidden" name="max" value="<?=$HTTP_POST_VARS["max"]?>">
<input type="hidden" name="wahr" value="<?=$HTTP_POST_VARS["wahr"]?>">
<input type="hidden" name="lang" value="<?=$HTTP_POST_VARS["lang"]?>">
<input type="hidden" name="instabil" value="<?=$HTTP_POST_VARS["instabil"]?>">
<input type="hidden" name="stabil" value="<?=$HTTP_POST_VARS["stabil"]?>">
<input type="hidden" name="leminvorkommen" value="<?=$HTTP_POST_VARS["leminvorkommen"]?>">
<input type="hidden" name="umfang" value="<?=$HTTP_POST_VARS["umfang"]?>">
<input type="hidden" name="struktur" value="<?=$HTTP_POST_VARS["struktur"]?>">
<input type="hidden" name="modul_0" value="<?=$HTTP_POST_VARS["modul_0"]?>">
<input type="hidden" name="modul_2" value="<?=$HTTP_POST_VARS["modul_2"]?>">
<input type="hidden" name="modul_3" value="<?=$HTTP_POST_VARS["modul_3"]?>">
<input type="hidden" name="out" value="<?=$HTTP_POST_VARS["out"]?>">
<input type="hidden" name="nebel" value="<?=$HTTP_POST_VARS["nebel"]?>">

<input type="hidden" name="piraten_mitte" value="<?=$HTTP_POST_VARS["piraten_mitte"]?>">
<input type="hidden" name="piraten_aussen" value="<?=$HTTP_POST_VARS["piraten_aussen"]?>">
<input type="hidden" name="piraten_min" value="<?=$HTTP_POST_VARS["piraten_min"]?>">
<input type="hidden" name="piraten_max" value="<?=$HTTP_POST_VARS["piraten_max"]?>">


<? if ($HTTP_POST_VARS["siegbedingungen"]==6) {  ?>
<input type="hidden" name="team1" value="<?=$HTTP_POST_VARS["team1"]?>">
<input type="hidden" name="team2" value="<?=$HTTP_POST_VARS["team2"]?>">
<input type="hidden" name="team3" value="<?=$HTTP_POST_VARS["team3"]?>">
<input type="hidden" name="team4" value="<?=$HTTP_POST_VARS["team4"]?>">
<input type="hidden" name="team5" value="<?=$HTTP_POST_VARS["team5"]?>">
<input type="hidden" name="team6" value="<?=$HTTP_POST_VARS["team6"]?>">
<input type="hidden" name="team7" value="<?=$HTTP_POST_VARS["team7"]?>">
<input type="hidden" name="team8" value="<?=$HTTP_POST_VARS["team8"]?>">
<input type="hidden" name="team9" value="<?=$HTTP_POST_VARS["team9"]?>">
<input type="hidden" name="team10" value="<?=$HTTP_POST_VARS["team10"]?>">
<? } ?>
<br><br><br><br><br>
<center>
...
$sid=zufallstring();
$spielname=$HTTP_POST_VARS["spiel_name"];
   $spielname=str_replace("'"," ",$spielname);
   $spielname=str_replace('"'," ",$spielname);


$ziel_id=$HTTP_POST_VARS["siegbedingungen"];
$umfang=$HTTP_POST_VARS["umfang"];
$struktur=$HTTP_POST_VARS["struktur"];

$piraten_mitte=$HTTP_POST_VARS["piraten_mitte"];
$piraten_aussen=$HTTP_POST_VARS["piraten_aussen"];
$piraten_min=$HTTP_POST_VARS["piraten_min"];
$piraten_max=$HTTP_POST_VARS["piraten_max"];
$out=$HTTP_POST_VARS["out"];

if ($ziel_id==6) {
 $team[1]=$HTTP_POST_VARS["team1"];
 $team[2]=$HTTP_POST_VARS["team2"];
 $team[3]=$HTTP_POST_VARS["team3"];
 $team[4]=$HTTP_POST_VARS["team4"];
 $team[5]=$HTTP_POST_VARS["team5"];
 $team[6]=$HTTP_POST_VARS["team6"];
 $team[7]=$HTTP_POST_VARS["team7"];
 $team[8]=$HTTP_POST_VARS["team8"];
 $team[9]=$HTTP_POST_VARS["team9"];
 $team[10]=$HTTP_POST_VARS["team10"];
}

$module = array();
$module[0] = @intval($HTTP_POST_VARS["modul_0"]);
$module[1] = 0;
$module[2] = @intval($HTTP_POST_VARS["modul_2"]);
$module[3] = @intval($HTTP_POST_VARS["modul_3"]);
...
$sternendichte=$HTTP_POST_VARS["sternendichte"];
$startposition=$HTTP_POST_VARS["startposition"];
...
//for ($i=0;$i<50;$i++) {
  ...
  if ($klasse==4) { $bild=rand(1,14);$temp=rand(50,75); }  //Klasse L warm nur wenig Wasseroberfläche
  if ($klasse==5) { $bild=rand(1,11);$temp=rand(86,100); }  //Klasse G Wüstenplanet
  ...
  if ($klasse==9) { $bild=rand(1,9);$temp=rand(25,45); }    //Klasse F jung zerklüftet
  ...
  if ($HTTP_POST_VARS["mineralien"]==1) { $minrand=1000;$maxrand=7000; }
  if ($HTTP_POST_VARS["mineralien"]==2) { $minrand=800;$maxrand=5000; }
  if ($HTTP_POST_VARS["mineralien"]==3) { $minrand=500;$maxrand=3500; }
  if ($HTTP_POST_VARS["mineralien"]==4) { $minrand=100;$maxrand=1500; }
...
if ($HTTP_POST_VARS["spezien"]>=1) {
   $zufall=rand(1,100);
   if ($zufall<=$HTTP_POST_VARS["spezien"]) {
...
///////////////////////////////////////////////INSTABLIE WURMLÖCHER ANFANG

if ($HTTP_POST_VARS["instabil"]>=1) {
for ($i=0;$i<$HTTP_POST_VARS["instabil"];$i++) {
...
///////////////////////////////////////////////INSTABLIE WURMLÖCHER ENDE

///////////////////////////////////////////////STABILE WURMLÖCHER ANFANG

if ($HTTP_POST_VARS["stabil"]>=1) {

  if ($HTTP_POST_VARS["stabil"]<=5) {$anzahl=$HTTP_POST_VARS["stabil"];}
  if ($HTTP_POST_VARS["stabil"]==6) {$anzahl=1;}
  if ($HTTP_POST_VARS["stabil"]==7) {$anzahl=2;}
  if ($HTTP_POST_VARS["stabil"]==8) {$anzahl=1;}
  if ($HTTP_POST_VARS["stabil"]==9) {$anzahl=2;}
  if ($HTTP_POST_VARS["stabil"]==10) {$anzahl=2;}
  if ($HTTP_POST_VARS["stabil"]==11) {$anzahl=1;}
  if ($HTTP_POST_VARS["stabil"]==12) {$anzahl=1;}
  if ($HTTP_POST_VARS["stabil"]==13) {$anzahl=2;}
  ...
  if ($HTTP_POST_VARS["stabil"]<=5) { $x=rand(50,$umfang-100);$y=rand(50,$umfang-100); }

  if ($HTTP_POST_VARS["stabil"]==6) { $x=rand(50,$umfang-100);$y=rand(50,($umfang/2)-50); }
  if ($HTTP_POST_VARS["stabil"]==7) { $x=rand(50,$umfang-100);$y=rand(50,($umfang/2)-50); }

  if ($HTTP_POST_VARS["stabil"]==8) { $x=rand(50,($umfang/2)-50);$y=rand(50,$umfang-100); }
  if ($HTTP_POST_VARS["stabil"]==9) { $x=rand(50,($umfang/2)-50);$y=rand(50,$umfang-100); }

  if (($HTTP_POST_VARS["stabil"]==10) and ($i==0)) { $x=rand(50,$umfang-100);$y=rand(50,($umfang/2)-50); }
  if (($HTTP_POST_VARS["stabil"]==10) and ($i==1)) { $x=rand(50,($umfang/2)-50);$y=rand(50,$umfang-100); }

  if ($HTTP_POST_VARS["stabil"]==11) { $x=rand(50,($umfang/2)-50);$y=rand(50,($umfang/2)-50); }
  if ($HTTP_POST_VARS["stabil"]==12) { $x=rand(($umfang/2)+50,$umfang-100);$y=rand(50,($umfang/2)-50); }

  if (($HTTP_POST_VARS["stabil"]==13) and ($i==0)) { $x=rand(50,($umfang/2)-50);$y=rand(50,($umfang/2)-50); }
  if (($HTTP_POST_VARS["stabil"]==13) and ($i==1)) { $x=rand(($umfang/2)+50,$umfang-100);$y=rand(50,($umfang/2)-50); }
  ...
  if ($HTTP_POST_VARS["stabil"]==6) { $x=rand(50,$umfang-100);$y=rand(($umfang/2)+50,$umfang-100); }
  if ($HTTP_POST_VARS["stabil"]==7) { $x=rand(50,$umfang-100);$y=rand(($umfang/2)+50,$umfang-100); }

  if ($HTTP_POST_VARS["stabil"]==8) { $x=rand(($umfang/2)+50,$umfang-100);$y=rand(50,$umfang-100); }
  if ($HTTP_POST_VARS["stabil"]==9) { $x=rand(($umfang/2)+50,$umfang-100);$y=rand(50,$umfang-100); }

  if (($HTTP_POST_VARS["stabil"]==10) and ($i==0)) { $x=rand(50,$umfang-100);$y=rand(($umfang/2)+50,$umfang-100); }
  if (($HTTP_POST_VARS["stabil"]==10) and ($i==1)) { $x=rand(($umfang/2)+50,$umfang-100);$y=rand(50,$umfang-100); }

  if ($HTTP_POST_VARS["stabil"]==11) { $x=rand(($umfang/2)+50,$umfang-100);$y=rand(($umfang/2)+50,$umfang-100); }
  if ($HTTP_POST_VARS["stabil"]==12) { $x=rand(50,($umfang/2)-50);$y=rand(($umfang/2)+50,$umfang-100); }

  if (($HTTP_POST_VARS["stabil"]==13) and ($i==0)) { $x=rand(($umfang/2)+50,$umfang-100);$y=rand(($umfang/2)+50,$umfang-100); }
  if (($HTTP_POST_VARS["stabil"]==13) and ($i==1)) { $x=rand(50,($umfang/2)-50);$y=rand(($umfang/2)+50,$umfang-100); }
...
///////////////////////////////////////////////STABILE WURMLÖCHER ENDE

////////////////////////////////////////////////WER SPIELT MIT

$spieleranzahl=0;

if ($HTTP_POST_VARS["user_1"]>=1) { $spieleranzahl++;$spieler[1][0]=$HTTP_POST_VARS["user_1"];$spieler[1][1]=$HTTP_POST_VARS["rasse_1"]; } else { $spieler[1][0]=0;$spieler[1][1]=''; }
if ($HTTP_POST_VARS["user_2"]>=1) { $spieleranzahl++;$spieler[2][0]=$HTTP_POST_VARS["user_2"];$spieler[2][1]=$HTTP_POST_VARS["rasse_2"]; } else { $spieler[2][0]=0;$spieler[2][1]=''; }
if ($HTTP_POST_VARS["user_3"]>=1) { $spieleranzahl++;$spieler[3][0]=$HTTP_POST_VARS["user_3"];$spieler[3][1]=$HTTP_POST_VARS["rasse_3"]; } else { $spieler[3][0]=0;$spieler[3][1]=''; }
if ($HTTP_POST_VARS["user_4"]>=1) { $spieleranzahl++;$spieler[4][0]=$HTTP_POST_VARS["user_4"];$spieler[4][1]=$HTTP_POST_VARS["rasse_4"]; } else { $spieler[4][0]=0;$spieler[4][1]=''; }
if ($HTTP_POST_VARS["user_5"]>=1) { $spieleranzahl++;$spieler[5][0]=$HTTP_POST_VARS["user_5"];$spieler[5][1]=$HTTP_POST_VARS["rasse_5"]; } else { $spieler[5][0]=0;$spieler[5][1]=''; }
if ($HTTP_POST_VARS["user_6"]>=1) { $spieleranzahl++;$spieler[6][0]=$HTTP_POST_VARS["user_6"];$spieler[6][1]=$HTTP_POST_VARS["rasse_6"]; } else { $spieler[6][0]=0;$spieler[6][1]=''; }
if ($HTTP_POST_VARS["user_7"]>=1) { $spieleranzahl++;$spieler[7][0]=$HTTP_POST_VARS["user_7"];$spieler[7][1]=$HTTP_POST_VARS["rasse_7"]; } else { $spieler[7][0]=0;$spieler[7][1]=''; }
if ($HTTP_POST_VARS["user_8"]>=1) { $spieleranzahl++;$spieler[8][0]=$HTTP_POST_VARS["user_8"];$spieler[8][1]=$HTTP_POST_VARS["rasse_8"]; } else { $spieler[8][0]=0;$spieler[8][1]=''; }
if ($HTTP_POST_VARS["user_9"]>=1) { $spieleranzahl++;$spieler[9][0]=$HTTP_POST_VARS["user_9"];$spieler[9][1]=$HTTP_POST_VARS["rasse_9"]; } else { $spieler[9][0]=0;$spieler[9][1]=''; }
if ($HTTP_POST_VARS["user_10"]>=1) { $spieleranzahl++;$spieler[10][0]=$HTTP_POST_VARS["user_10"];$spieler[10][1]=$HTTP_POST_VARS["rasse_10"]; } else { $spieler[10][0]=0;$spieler[10][1]=''; }
...
if (($HTTP_POST_VARS["imperiumgroesse"]==1) or ($HTTP_POST_VARS["imperiumgroesse"]==2) or ($HTTP_POST_VARS["imperiumgroesse"]==3) or ($HTTP_POST_VARS["imperiumgroesse"]==4)) {

if ($HTTP_POST_VARS["imperiumgroesse"]==1) {
...
for ($i=1;$i<=10;$i++) {
  ...
  $abwehr=5;
  $fabriken=5;
  $cantox=$HTTP_POST_VARS["geldmittel"];
  ...
  if ($HTTP_POST_VARS["mineralienhome"]==1) { $minrand=2000;$maxrand=3000; }
  if ($HTTP_POST_VARS["mineralienhome"]==2) { $minrand=1500;$maxrand=2500; }
  if ($HTTP_POST_VARS["mineralienhome"]==3) { $minrand=1000;$maxrand=2000; }
  if ($HTTP_POST_VARS["mineralienhome"]==4) { $minrand=500;$maxrand=1000; }
...
if (($HTTP_POST_VARS["imperiumgroesse"]==1) or ($HTTP_POST_VARS["imperiumgroesse"]==2)) {
...
if ($ziel_id==1) {
   $ziel_info=$HTTP_POST_VARS["zielinfo_1"];
}
if ($ziel_id==2) {
...
if ($ziel_id==5) {
   $ziel_info=$HTTP_POST_VARS["zielinfo_5"];
   $spieler_1_ziel="0";
   $spieler_2_ziel="0";
   $spieler_3_ziel="0";
   $spieler_4_ziel="0";
...
$plasma_wahr=$HTTP_POST_VARS["wahr"];
$plasma_lang=$HTTP_POST_VARS["lang"];
$plasma_max=$HTTP_POST_VARS["max"];
$spieler_admin=$HTTP_POST_VARS["spieler_admin"];

   if (strlen($spieler_1_rasse)>=2) { $spieler_1_rassename=$namerassen[$spieler_1_rasse];  }
   if (strlen($spieler_2_rasse)>=2) { $spieler_2_rassename=$namerassen[$spieler_2_rasse];  }
   if (strlen($spieler_3_rasse)>=2) { $spieler_3_rassename=$namerassen[$spieler_3_rasse];  }
   if (strlen($spieler_4_rasse)>=2) { $spieler_4_rassename=$namerassen[$spieler_4_rasse];  }
   if (strlen($spieler_5_rasse)>=2) { $spieler_5_rassename=$namerassen[$spieler_5_rasse];  }
   if (strlen($spieler_6_rasse)>=2) { $spieler_6_rassename=$namerassen[$spieler_6_rasse];  }
   if (strlen($spieler_7_rasse)>=2) { $spieler_7_rassename=$namerassen[$spieler_7_rasse];  }
   if (strlen($spieler_8_rasse)>=2) { $spieler_8_rassename=$namerassen[$spieler_8_rasse];  }
   if (strlen($spieler_9_rasse)>=2) { $spieler_9_rassename=$namerassen[$spieler_9_rasse];  }
   if (strlen($spieler_10_rasse)>=2) { $spieler_10_rassename=$namerassen[$spieler_10_rasse];  }


echo $query="UPDATE $skrupel_spiele set
                             sid='$sid',
                             ziel_id=$ziel_id,
                             ziel_info='$ziel_info',
                             spieler_1=$spieler_1,
